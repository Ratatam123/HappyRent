...
from wtforms import StringField, IntegerField, DecimalField, BooleanField, TextAreaField, PasswordField, SubmitField, SelectField ## wie Zeile umbrechen??
...
class TypeForm(FlaskForm):
    ...
    submit = SubmitField('Save the category and let me give you more info about the offer')
...
class ItemForm(FlaskForm): 
    ...
    size = IntegerField('Size in square meters (whole number)', validators=[DataRequired()],render_kw={"placeholder": "50"})
    rent = IntegerField('Rent in € (whole amount without cents)', validators=[DataRequired()], render_kw={"placeholder": "100"})
...
class LocalRegistrationForm(FlaskForm):
    ...
    password = PasswordField('Add a local Password to your Github username', validators=[DataRequired()])
